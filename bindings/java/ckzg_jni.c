...
void throw_c_kzg_exception(JNIEnv *env, C_KZG_RET error_code,
  ...
  jclass exception_class =
      (*env)->FindClass(env, "org/tron/common/crypto/ckzg4844/CKZGException");
...
Java_org_tron_common_crypto_ckzg4844_CKZG4844JNI_loadTrustedSetup__Ljava_lang_String_2J(
...
JNIEXPORT void JNICALL
Java_org_tron_common_crypto_ckzg4844_CKZG4844JNI_loadTrustedSetup___3B_3B_3BJ(
...
Java_org_tron_common_crypto_ckzg4844_CKZG4844JNI_blobToKzgCommitment(JNIEnv *env,
                                                       jclass thisCls,
                                                       jbyteArray blob) {
  if (settings == NULL) {
    throw_exception(env, TRUSTED_SETUP_NOT_LOADED);
...
JNIEXPORT jobject JNICALL Java_org_tron_common_crypto_ckzg4844_CKZG4844JNI_computeKzgProof(
  ...
  jclass proof_and_y_class =
      (*env)->FindClass(env, "org/tron/common/crypto/ckzg4844/ProofAndY");
...
JNIEXPORT jbyteArray JNICALL
Java_org_tron_common_crypto_ckzg4844_CKZG4844JNI_computeBlobKzgProof(
...
Java_org_tron_common_crypto_ckzg4844_CKZG4844JNI_verifyBlobKzgProof(
    JNIEnv *env, jclass thisCls, jbyteArray blob, jbyteArray commitment_bytes,
...
JNIEXPORT jboolean JNICALL
Java_org_tron_common_crypto_ckzg4844_CKZG4844JNI_verifyBlobKzgProofBatch(
...
JNIEXPORT jobject JNICALL Java_org_tron_common_crypto_ckzg4844_CKZG4844JNI_computeCells(
...
Java_org_tron_common_crypto_ckzg4844_CKZG4844JNI_computeCellsAndKzgProofs(JNIEnv *env,
                                                            jclass thisCls,
                                                            jbyteArray blob) {
  if (settings == NULL) {
    throw_exception(env, TRUSTED_SETUP_NOT_LOADED);
  ...
  jclass caps_class =
      (*env)->FindClass(env, "org/tron/common/crypto/ckzg4844/CellsAndProofs");
  if (caps_class == NULL) {
...
JNIEXPORT jbyteArray JNICALL
Java_org_tron_common_crypto_ckzg4844_CKZG4844JNI_recoverCellsAndKzgProofs(
...
JNIEXPORT jboolean JNICALL
Java_org_tron_common_crypto_ckzg4844_CKZG4844JNI_verifyCellKzgProofBatch(
